...
const features = [
  {
    ...
    description: "Learn from curated video courses on web development, design, and more. Track your progress and pick up right where you left off.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Project Showcase",
    description: "Build real-world projects and showcase them to the community. Add live demos, GitHub links, and get discovered by recruiters.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Apply as Internee",
    description: "Submit your internship application with your skills and portfolio. Track your application status in real-time.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Progress Tracking",
    description: "Monitor your learning journey with detailed progress tracking. See stats on videos watched, projects submitted, and more.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">Learn. Build. Get hired.</span>
          </h2>
        </div>
